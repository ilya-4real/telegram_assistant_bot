...
from app.handlers.currency_handlers import router as currency_router


async def main():
    bot = Bot(API_KEY, parse_mode=ParseMode.HTML)
    dp = Dispatcher()
    dp.include_routers(main_router, currency_router, task_router, email_router, city_router)
